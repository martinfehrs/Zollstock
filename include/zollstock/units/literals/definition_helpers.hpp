...
#define ZOLLSTOCK_DEFINE_LITERALS(suffix, constant)                                             \
    ZOLLSTOCK_MODULE_EXPORT [[nodiscard]] consteval auto operator"" _##suffix(                  \
    ...
    {                                                                                           \
        ...
        return quantity<constant, int>{ narrow<int>(value) };                                   \
                                                                                                ...
                                                                                                \
    ZOLLSTOCK_MODULE_EXPORT [[nodiscard]] consteval auto operator"" _l_##suffix(                \
        unsigned long long int value                                                            \
    ) noexcept                                                                                  \
    {                                                                                           \
        using namespace ::zollstock;                                                            \
        ...
        return quantity<constant, long int>{ narrow<long int>(value) };                         \
                                                                                                ...
                                                                                                \
    ZOLLSTOCK_MODULE_EXPORT [[nodiscard]] consteval auto operator"" _ll_##suffix(               \
        unsigned long long int value                                                            \
    ) noexcept                                                                                  \
    {                                                                                           \
        using namespace ::zollstock;                                                            \
        ...
        return quantity<constant, long long int>{ narrow<long long int>(value) };               \
                                                                                                ...
                                                                                                \
    ZOLLSTOCK_MODULE_EXPORT [[nodiscard]] consteval auto operator"" _u_##suffix(                \
        unsigned long long int value                                                            \
    ) noexcept                                                                                  \
    {                                                                                           \
        using namespace ::zollstock;                                                            \
        ...
        return quantity<constant, unsigned int>{ narrow<unsigned int>(value) };                 \
                                                                                                ...
                                                                                                \
    ZOLLSTOCK_MODULE_EXPORT [[nodiscard]] consteval auto operator"" _ul_##suffix(               \
        unsigned long long int value                                                            \
    ) noexcept                                                                                  \
    {                                                                                           \
        using namespace ::zollstock;                                                            \
        ...
        return quantity<constant, unsigned long int>{ narrow<unsigned long int>(value) };       \
                                                                                                ...
                                                                                                \
    ZOLLSTOCK_MODULE_EXPORT [[nodiscard]] consteval auto operator"" _ull_##suffix(              \
        unsigned long long int value                                                            \
    ) noexcept                                                                                  \
    {                                                                                           \
        using namespace ::zollstock;                                                            \
        ...
        return quantity<constant, unsigned long long int>{ value };                             \
                                                                                                ...
                                                                                                \
    ZOLLSTOCK_MODULE_EXPORT [[nodiscard]] consteval auto operator"" _##suffix(long double value)\
    {                                                                                           \
        using namespace ::zollstock;                                                            \
                                                                                                \
        if (                                                                                    \
        ...
        return quantity<constant, double>{ static_cast<double>(value) };                        \
                                                                                                ...
                                                                                                \
    ZOLLSTOCK_MODULE_EXPORT [[nodiscard]] consteval auto operator"" _f_##suffix(                \
        long double value                                                                       \
    )                                                                                           \
    {                                                                                           \
        using namespace ::zollstock;                                                            \

#ifndef __ZOLLSTOCK_QUANTITIES_CONCEPTS_QUANTITY_HPP__
#define __ZOLLSTOCK_QUANTITIES_CONCEPTS_QUANTITY_HPP__
...
#endif //__ZOLLSTOCK_QUANTITIES_CONCEPTS_QUANTITY_HPP__
